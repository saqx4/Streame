...
const TVShowDetail: React.FC = () => {
  ...
  const toggleWatchlist = async () => {
    ...
    try {
      ...
      if (inWatchlist) {
        console.log('Removing from watchlist:', { userId: user.id, tvShowId: tvShow.id });
        await userMediaService.remove(user.id, tvShow.id, 'watchlist');
        setInWatchlist(false);
        console.log('Removed successfully');
      } else {
        console.log('Adding to watchlist:', { userId: user.id, tvShowId: tvShow.id, title: tvShow.name });
                ...
                >
                  <div className="episode-still">
                    ...
                    <div className="episode-still-overlay">
                      <button className="episode-play-chip">Play</button>
                    </div>
                  </div>
                  <div className="episode-meta">
