...
<div class="fixed inset-0 z-[-1] overflow-hidden">
  ...
  ></div>
  <div
    class="absolute inset-0 bg-linear-to-t from-[#050505] via-[#050505]/90 to-[#050505]/70"
  ></div>
  <!-- Animated gradient orbs -->
  <div
    class="absolute top-1/4 -left-20 w-80 h-80 bg-yellow-400/20 rounded-full blur-[100px] animate-pulse"
  ></div>
  <div
    class="absolute bottom-1/4 -right-20 w-80 h-80 bg-yellow-400/10 rounded-full blur-[100px] animate-pulse"
    style="animation-delay: 1s;"
  ></div>
</div>

<section class="min-h-[80vh] flex items-center justify-center p-4">
  <div class="w-full max-w-[440px] relative" in:fly={{ y: 20, duration: 600 }}>
    <!-- Logo/Brand area -->
    <div class="text-center mb-8">
      <div
        class="inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-yellow-400 mb-4 shadow-[0_0_60px_-10px_rgba(250,204,21,0.5)] pulse-glow"
      >
      ...
      <p class="text-white/30 text-sm mt-1 font-medium">
        Elevate your streaming experience
      </p>
    </div>

    <div
      class="rounded-[32px] border border-white/5 bg-black/50 p-6 sm:p-10 backdrop-blur-3xl shadow-2xl overflow-hidden relative"
    >
      <!-- Top Accent -->
      <div
        class="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-yellow-400/50 to-transparent"
      ></div>

      <!-- Corner accents -->
      <div
        class="absolute top-0 left-0 w-20 h-20 border-l border-t border-yellow-400/20 rounded-tl-[32px]"
      ></div>
      <div
        class="absolute top-0 right-0 w-20 h-20 border-r border-t border-yellow-400/20 rounded-tr-[32px]"
      ></div>
      ...
      <div
        class="grid grid-cols-2 gap-2 rounded-2xl bg-white/5 p-1 border border-white/5 mb-8"
      >
        <button
      ...
      <div class="space-y-5">
        <div class="space-y-2">
          <label
            for="login-email"
            class="text-[10px] font-black uppercase tracking-[0.2em] text-white/30 ml-1"
            >Email or Username</label
          >
          <div class="relative group">
            <div
              class="absolute inset-y-0 left-4 flex items-center text-white/20 group-focus-within:text-yellow-400/60 transition-colors"
            >
              <Mail size={16} />
            </div>
            <input
        ...
        >
          ...
          <div
            class="absolute inset-0 bg-linear-to-r from-transparent via-white/30 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] duration-700 transition-transform"
          ></div>
        </button>

        <div
          class="flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-widest text-white/20 pt-4"
        >
          <Shield size={12} />
          <span
            >{isSupabaseEnabled
    ...
    <p class="text-center mt-8 text-white/15 text-xs px-8">
      ...
      data is securely synced with Supabase.
    </p>
  </div>
</section>
