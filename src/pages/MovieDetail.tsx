        ...
        <div className="tabs-content">
          ...
          {activeTab === 'trailers' && (
            <div className="tab-panel">
              ...
              <p className="coming-soon">Trailers coming soon...</p>
            </div>
          )}
          ...
          {activeTab === 'cast' && (
            <div className="tab-panel">
              <h3>Cast & Crew</h3>
              <p className="coming-soon">Cast information coming soon...</p>
            </div>
          )}
          ...
          {activeTab === 'similar' && (
            <div className="tab-panel">
              ...
              <p className="coming-soon">Similar movies coming soon...</p>
            </div>
          )}
        </div>
      </div>
