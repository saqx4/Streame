...
const MovieDetail: React.FC = () => {
  ...
  const checkWatchlistStatus = async () => {
    ...
    try {
      ...
      console.log('Watchlist check:', { userId: user.id, movieId: movie.id, isInList, totalItems: items.length });
  ...
  const toggleWatchlist = async () => {
    ...
    try {
      ...
      if (inWatchlist) {
        console.log('Removing from watchlist:', { userId: user.id, movieId: movie.id });
        await userMediaService.remove(user.id, movie.id, 'watchlist');
        setInWatchlist(false);
        console.log('Removed successfully');
      } else {
        console.log('Adding to watchlist:', { userId: user.id, movieId: movie.id, title: movie.title });
